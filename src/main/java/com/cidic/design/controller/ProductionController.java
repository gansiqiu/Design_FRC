...
public class ProductionController  extends DcController{
	...
	public ListResultModel getDataTableProductionByPage(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			ProdutionPageModel pPageModel = productionServiceImpl.getListProductionByPage(iDisplayStart, iDisplayLength, groupId, round, status,fileType);
	...
	public ListResultModel getProductionPageByCondition(HttpServletRequest request, HttpServletResponse response, 
		...
		try {
			...
			ProdutionPageModel pPageModel = productionServiceImpl.getProductionPageByCondition(groupId, category, status, fileType, userId, round, iDisplayLength, iDisplayStart);
