                        ...
                        "aoColumns": [
                            ...
                            { "mDataProp": "pimage",
                                "fnRender":function(oObj){
                                	if(oObj.aData.pimage == null){
                                		return '<img class="thumb" src="resources/backend/images/app/sloganSmallImg.png">';
                                	}else{
...
$(document).ready(function(){
    ...
    $("#searchByFileType").change(function(){
        worksMgr.dataTable.tableRedraw();
    });
