			...
			<div class="panel panel-default">
				...
				<div class="panel-body" id="opt-body">
					...
					<div class="row">
						...
						<label class="col-md-1 zyHidden">作品类型：</label>
						<div class="col-md-2 zyHidden">
							<select class="form-control" id="searchByFileType">
								<option value="0">全部</option>
								<option value="1">图幅</option>
								<option value="3">口号</option>
							</select>
						</div>
					</div>
