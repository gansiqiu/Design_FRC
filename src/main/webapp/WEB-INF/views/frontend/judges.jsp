	...
	<script>
		$(document).ready(function(){
			var documentHeight = $(document.body).height(),
				JMJudgeListHeight = $("#JMJudge").height(),
				 JMFooterHeight = $(".JMFooter").height(),
				 addHeight = documentHeight - JMFooterHeight,
				 totalHeight = JMJudgeListHeight + JMFooterHeight ;
			 if(totalHeight < documentHeight){
				 $("#JMJudge").css({ "min-height": addHeight +"px" });
			 }
		})
