	...
	<div id="productList" style="width:100%">
		...
		<ul class="cd-items cd-container">
			<li v-for="item in list" class="cd-item" >
				...
				<p class="cd-slogan" v-show="item.slogan" :id="item.id" v-on:click="openDetail" style="cursor:pointer;">{{item.slogan}}</p>
		...
		<div class="cd-quick-view">
			...
			<div class="cd-item-info">
				...
				<div v-if="imgBox != '' ">
					原图片下载：<br/><a class="downImg" :href="imgBox" download="imgBox" >{{imgBox}}</a>
				</div>
				<div>
